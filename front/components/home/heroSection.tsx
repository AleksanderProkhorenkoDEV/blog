    ...
    return (
        <section className="min-h-[calc(100svh-80px)] p-4 flex items-center justify-center max-w-6xl mx-auto relative  max-md:p-0">
            <article className="flex flex-col gap-6">
                ...
                <h1 className={`${Konkhmer.className} text-5xl max-md:text-3xl max-xs:text-xl`}>Bienvenido a este blog,<br /><span className="text-primary">aquí ser un junior no es malo.</span></h1>
                <p className="font-bold text-secondary text-pretty w-2xl max-md:text-lg max-md:w-xl max-sm:text-sm max-sm:w-md max-xs:text-xs max-xs:w-xs">
