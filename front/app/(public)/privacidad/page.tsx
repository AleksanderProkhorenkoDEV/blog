...
export default function PrivacyPolicy() {
    return (
        <section className="max-w-3xl mx-auto py-10 px-4 clear-start flex flex-col gap-4">
            ...
            <p>
                Aleksander Trujillo Prokhorenko, con contacto en <CustomLink href="mailto:aprokhorenkodev@gmail.com" isUnderline={false} className="display">aprokhorenkodev@gmail.com</CustomLink>,
            ...
            <p>
                ...
                Puedes solicitar su eliminación en cualquier momento escribiendo a <CustomLink href="mailto:aprokhorenkodev@gmail.com"  className="display">aprokhorenkodev@gmail.com</CustomLink>
            </p>
            ...
            <p>
                ...
                escribiendo a <CustomLink href="mailto:aprokhorenkodev@gmail.com"  className="display">aprokhorenkodev@gmail.com</CustomLink>.
                También puedes presentar una reclamación ante la
                <CustomLink href="https://www.aepd.es"  className="display"> Agencia Española de Protección de Datos (AEPD)</CustomLink> si consideras que tus derechos no han sido respetados.
            </p>

            <h2 className="text-xl bold"><span className={`text-primary ${jetBrain.className}`}>8.</span> Terceros implicados</h2>
            <p>
                Usamos <CustomLink href="https://supabase.com"  className="display">Supabase</CustomLink> como 
                proveedor de autenticación y base de datos, con servidores alojados
                en Irlanda (Unión Europea). Puedes consultar su política de privacidad en <CustomLink href="https://supabase.com/privacy"  className="display">supabase.com/privacy</CustomLink>
            </p>
        </section >
    )
}